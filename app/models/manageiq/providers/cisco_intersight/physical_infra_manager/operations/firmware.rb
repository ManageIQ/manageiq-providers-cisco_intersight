module ManageIQ::Providers::CiscoIntersight
  module PhysicalInfraManager::Operations::Firmware
    ...
    def compatible_firmware_url(update_service, firmware_binary)
      ...
      requested = update_action['TransferProtocol@CiscoIntersight.AllowableValues']
      requested ||= begin
        params = update_action['TransferProtocol@CiscoIntersight.ActionInfo']&.Parameters || []
        params.find { |p| p.Name == 'TransferProtocol' }&.AllowableValues
      end
      if requested.blank?
        raise MiqException::MiqFirmwareUpdateError, 'CiscoIntersight supports zero transfer protocols'
      end
