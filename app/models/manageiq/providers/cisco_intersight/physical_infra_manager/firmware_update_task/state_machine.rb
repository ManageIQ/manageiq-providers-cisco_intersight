module ManageIQ::Providers::CiscoIntersight::PhysicalInfraManager::FirmwareUpdateTask::StateMachine
  ...
  def trigger_firmware_update
    update_and_notify_parent(:message => msg('trigger firmware update via CiscoIntersight'))
